...
- ![Version 3](readmev3.md) (the default version for backward compatibility) uses a few verbs to steer the flow.

- ![Version 4](readmev4.md) has more options and uses a pure array to steer the flow more flexibly.
